...
namespace WebDriverManagerSharp.Tests.Test
{
    ...
    public class PhantomJsFilterTest
    {
        ...
        public void TestFilterPhantomJs()
        {
            ...
            List<Uri> filteredLatestUrls = new UrlFilter(Resolver.Resolve<ILogger>(), new FileStorage()).FilterByArch(latestUrls, Architecture.X64, false);
        ...
        public void TestFilterVersionPhantomJs()
        {
            ...
            List<Uri> filteredVersionUrls = new UrlFilter(Resolver.Resolve<ILogger>(), new FileStorage()).FilterByArch(specificVersionUrls, Architecture.X64, false);
