...
namespace WebDriverManagerSharp.UnitTests.Managers
{
    ...
    public class OperaDriverManagerTests
    {
        ...
        public void Test()
        {
            ...
            httpClientMock.Setup(x => x.ExecuteHttpGet(new System.Uri("https://api.github.com/repos/operasoftware/operachromiumdriver/releases"), It.IsAny<AuthenticationHeaderValue>())).Returns(new MemoryStream(Encoding.ASCII.GetBytes(fakeJson)));
