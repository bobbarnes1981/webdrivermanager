...
namespace WebDriverManagerSharp.UnitTests.Managers
{
    ...
    public class FirefoxDriverManagerTests
    {
        ...
        public void Test()
        {
            ...
            httpClientMock.Setup(x => x.ExecuteHttpGet(new System.Uri("https://api.github.com/repos/mozilla/geckodriver/releases"), It.IsAny<AuthenticationHeaderValue>())).Returns(new MemoryStream(Encoding.ASCII.GetBytes(fakeJson)));
